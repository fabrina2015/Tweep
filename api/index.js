...
mongoose
  .connect("mongodb+srv://fabrina:fabrice@cluster0.reo2kzi.mongodb.net/", {
...
const sendVerificationEmail = async (email, verificationToken) => {
  ...
  const transporter = nodemailer.createTransport({
    service: "gmail",
    auth: {
      user: "fabrina2015@gmail.com",
      pass: "sekg ogxe pptl wvf",
    },
  });
  ...
  const mailOptions = {
    ...
    text: `please click the following link to verify your email http://192.168.100.7:3000/verify/${verificationToken}`,
  };
